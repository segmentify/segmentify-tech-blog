package com.segmentify.ordermanagement.config;
...
public class SwaggerConfig {
    ...
    public Docket swagConfig() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.segmentify"))
                .build()
                .apiInfo(getApiInfo());
    }
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo("Order management application",
                ...
                new Contact("Emir Gökdemir", "https://www.segmentify.com",
